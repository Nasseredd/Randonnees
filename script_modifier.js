/*
    Fonction de validation du formulaire de la modfication d'une randonée.
*/
function validateform(){
    ...
    var denivele_neg=Number.parseFloat(document.getElementById('denivele_neg').value) ;
     ...
     {
        document.getElementById('text1').innerHTML='Pour modifier une randonnée, vous devez remplir tous les champs avec (*)! ';
